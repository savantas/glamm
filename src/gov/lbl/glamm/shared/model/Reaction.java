...
import gov.lbl.glamm.shared.model.interfaces.HasOptions;
...
implements Serializable, HasOptions, HasMeasurements, HasType, HasXrefs, HasSynonyms {
	...
	private transient ReactionColor color;
	...
	public Reaction(final Reaction reaction) {
		direction = reaction.direction;
		isNative = reaction.isNative;
		ecNums = reaction.ecNums;
		genes = reaction.genes;
		products = reaction.products;
		substrates = reaction.substrates;
		transgenicCandidates = reaction.transgenicCandidates;
		name2TransgenicCandidate = reaction.name2TransgenicCandidate;
		transgenicCandidate2EcNums = reaction.transgenicCandidate2EcNums;
		measurementSet = reaction.measurementSet;
		xrefSet = reaction.xrefSet;
