...
public class FBAChooserView extends Composite implements FBAChooserPresenter.View {

	private static final String TEXT_LOAD_SUBSET_BTN = "Load FBA results";
	private static final String TEXT_ADD_SUBSET_BTN = "Add results to subset";
	private static final String TEXT_REM_SUBSET_BTN = "Remove selected from subset";
	private static final String TEXT_CLEAR_SUBSET_BTN = "Clear results from subset";
	private static final String TEXT_CANCEL_BTN = "Cancel";
	
	private static final String TEXT_WORKSPACE_LBL = "Choose a workspace: ";
	private static final String TEXT_EMPTY_WORKSPACE_LBL = "No FBA results found in workspace!";
	private static final String TEXT_EMPTY_SUBSET_LBL = "No FBA selected!";
