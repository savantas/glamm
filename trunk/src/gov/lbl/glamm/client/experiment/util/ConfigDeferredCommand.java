/*
 * Modified to control the timer delay. Original class at
...
/**
 * Copy of {@link com.google.gwt.user.client.DeferredCommand},
 * but used with {@link gov.lbl.glamm.experiment.client.util.DelayConfigCommandExecutor}.
 * <p>
 * 
...
public class ConfigDeferredCommand {
  private static final DelayConfigCommandExecutor commandExecutor
  		= new DelayConfigCommandExecutor(30);
  ...
  /**
   * Adds a "pause" to the queue of {@link ConfigDeferredCommand}s. Any
   * {@link ConfigDeferredCommand}s or pauses that are added after this pause will
   * wait for an additional cycle through the system event loop before
   * executing.
   */
