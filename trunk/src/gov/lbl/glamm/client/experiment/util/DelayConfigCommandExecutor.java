...
/**
 * Copy of {@link com.google.gwt.user.client.CommandExecutor}, but with a configurable delay.
 * <p>
...
public class DelayConfigCommandExecutor {

	private int delayMillis = 1;

	public DelayConfigCommandExecutor(int delayMillis) {
  ...
  protected void maybeStartExecutionTimer() {
    if (!commands.isEmpty() && !isExecutionTimerPending() && !isExecuting()) {
      ...
      executionTimer.schedule(this.delayMillis);
    }
  }
